...
ALTER TABLE dd_arvot OWNER TO hamsteri;

--
-- Name: dd_arvot_id_seq; Type: SEQUENCE; Schema: public; Owner: hamsteri
--

CREATE SEQUENCE dd_arvot_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE dd_arvot_id_seq OWNER TO hamsteri;

--
-- Name: dd_arvot_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: hamsteri
--

ALTER SEQUENCE dd_arvot_id_seq OWNED BY dd_arvot.id;
...
ALTER TABLE kiekot OWNER TO hamsteri;

--
-- Name: kiekot_id_seq; Type: SEQUENCE; Schema: public; Owner: hamsteri
--

CREATE SEQUENCE kiekot_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE kiekot_id_seq OWNER TO hamsteri;

--
-- Name: kiekot_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: hamsteri
--

ALTER SEQUENCE kiekot_id_seq OWNED BY kiekot.id;
...
ALTER TABLE kirppis OWNER TO hamsteri;

--
-- Name: kirppis_id_seq; Type: SEQUENCE; Schema: public; Owner: hamsteri
--

CREATE SEQUENCE kirppis_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE kirppis_id_seq OWNER TO hamsteri;
...
ALTER TABLE members OWNER TO hamsteri;
...
ALTER TABLE members_id_seq OWNER TO hamsteri;
...
ALTER TABLE r_mold OWNER TO hamsteri;

--
-- Name: r_mold_id_seq; Type: SEQUENCE; Schema: public; Owner: hamsteri
--

CREATE SEQUENCE r_mold_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE r_mold_id_seq OWNER TO hamsteri;

--
-- Name: r_mold_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: hamsteri
--

ALTER SEQUENCE r_mold_id_seq OWNED BY r_mold.id;
...
ALTER TABLE r_muovi OWNER TO hamsteri;

--
-- Name: r_muovi_id_seq; Type: SEQUENCE; Schema: public; Owner: hamsteri
--

CREATE SEQUENCE r_muovi_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE r_muovi_id_seq OWNER TO hamsteri;

--
-- Name: r_muovi_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: hamsteri
--

ALTER SEQUENCE r_muovi_id_seq OWNED BY r_muovi.id;
...
ALTER TABLE r_valm OWNER TO hamsteri;

--
-- Name: r_valm_id_seq; Type: SEQUENCE; Schema: public; Owner: hamsteri
--

CREATE SEQUENCE r_valm_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE r_valm_id_seq OWNER TO hamsteri;

--
-- Name: r_valm_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: hamsteri
--

ALTER SEQUENCE r_valm_id_seq OWNED BY r_valm.id;
...
ALTER TABLE r_vari OWNER TO hamsteri;

--
-- Name: r_vari_id_seq; Type: SEQUENCE; Schema: public; Owner: hamsteri
--

CREATE SEQUENCE r_vari_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE r_vari_id_seq OWNER TO hamsteri;

--
-- Name: r_vari_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: hamsteri
--

ALTER SEQUENCE r_vari_id_seq OWNED BY r_vari.id;
...
ALTER TABLE wanted OWNER TO hamsteri;

--
-- Name: wanted_wanted_id_seq; Type: SEQUENCE; Schema: public; Owner: hamsteri
--

CREATE SEQUENCE wanted_wanted_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE wanted_wanted_id_seq OWNER TO hamsteri;

--
-- Name: wanted_wanted_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: hamsteri
--

ALTER SEQUENCE wanted_wanted_id_seq OWNED BY wanted.wanted_id;
...
ALTER TABLE ONLY dd_arvot ALTER COLUMN id SET DEFAULT nextval('dd_arvot_id_seq'::regclass);
...
ALTER TABLE ONLY kiekot ALTER COLUMN id SET DEFAULT nextval('kiekot_id_seq'::regclass);
...
ALTER TABLE ONLY r_mold ALTER COLUMN id SET DEFAULT nextval('r_mold_id_seq'::regclass);
...
ALTER TABLE ONLY r_muovi ALTER COLUMN id SET DEFAULT nextval('r_muovi_id_seq'::regclass);
...
ALTER TABLE ONLY r_valm ALTER COLUMN id SET DEFAULT nextval('r_valm_id_seq'::regclass);
...
ALTER TABLE ONLY r_vari ALTER COLUMN id SET DEFAULT nextval('r_vari_id_seq'::regclass);


--
-- Name: wanted_id; Type: DEFAULT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY wanted ALTER COLUMN wanted_id SET DEFAULT nextval('wanted_wanted_id_seq'::regclass);
...
COPY kirppis (id, kiekko_id, member_id, loytopaikka, puhelin, hakupaikka) FROM stdin;
\.
...
--
-- Name: dd_arvot_pkey; Type: CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY dd_arvot
    ADD CONSTRAINT dd_arvot_pkey PRIMARY KEY (id);


--
-- Name: kiekot_pkey; Type: CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY kiekot
    ADD CONSTRAINT kiekot_pkey PRIMARY KEY (id);


--
-- Name: kirppis_pkey; Type: CONSTRAINT; Schema: public; Owner: hamsteri
--
...
--
-- Name: members_pkey; Type: CONSTRAINT; Schema: public; Owner: hamsteri
--
...
--
-- Name: r_mold_pkey; Type: CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY r_mold
    ADD CONSTRAINT r_mold_pkey PRIMARY KEY (id);


--
-- Name: r_muovi_pkey; Type: CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY r_muovi
    ADD CONSTRAINT r_muovi_pkey PRIMARY KEY (id);


--
-- Name: r_valm_pkey; Type: CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY r_valm
    ADD CONSTRAINT r_valm_pkey PRIMARY KEY (id);


--
-- Name: r_vari_pkey; Type: CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY r_vari
    ADD CONSTRAINT r_vari_pkey PRIMARY KEY (id);


--
-- Name: wanted_pkey; Type: CONSTRAINT; Schema: public; Owner: hamsteri
--
...
--
-- Name: kiekot_ibfk_1; Type: FK CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY kiekot
    ADD CONSTRAINT kiekot_ibfk_1 FOREIGN KEY (member_id) REFERENCES members(id) ON UPDATE CASCADE;


--
-- Name: kiekot_ibfk_2; Type: FK CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY kiekot
    ADD CONSTRAINT kiekot_ibfk_2 FOREIGN KEY (mold_id) REFERENCES r_mold(id) ON UPDATE CASCADE;


--
-- Name: kiekot_ibfk_3; Type: FK CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY kiekot
    ADD CONSTRAINT kiekot_ibfk_3 FOREIGN KEY (muovi_id) REFERENCES r_muovi(id) ON UPDATE CASCADE;


--
-- Name: kiekot_ibfk_4; Type: FK CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY kiekot
    ADD CONSTRAINT kiekot_ibfk_4 FOREIGN KEY (vari_id) REFERENCES r_vari(id) ON UPDATE CASCADE;


--
-- Name: kirppis_ibfk_1; Type: FK CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY kirppis
    ADD CONSTRAINT kirppis_ibfk_1 FOREIGN KEY (kiekko_id) REFERENCES kiekot(id) ON UPDATE CASCADE;


--
-- Name: kirppis_ibfk_2; Type: FK CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY kirppis
    ADD CONSTRAINT kirppis_ibfk_2 FOREIGN KEY (member_id) REFERENCES members(id) ON UPDATE CASCADE;


--
-- Name: r_mold_ibfk_1; Type: FK CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY r_mold
    ADD CONSTRAINT r_mold_ibfk_1 FOREIGN KEY (valmistaja_id) REFERENCES r_valm(id) ON UPDATE CASCADE;


--
-- Name: r_muovi_ibfk_1; Type: FK CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY r_muovi
    ADD CONSTRAINT r_muovi_ibfk_1 FOREIGN KEY (valmistaja_id) REFERENCES r_valm(id) ON UPDATE CASCADE;


--
-- Name: wanted_ibfk_1; Type: FK CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY wanted
    ADD CONSTRAINT wanted_ibfk_1 FOREIGN KEY (member_id) REFERENCES members(id) ON UPDATE CASCADE;


--
-- Name: wanted_ibfk_2; Type: FK CONSTRAINT; Schema: public; Owner: hamsteri
--

ALTER TABLE ONLY wanted
    ADD CONSTRAINT wanted_ibfk_2 FOREIGN KEY (mold_id) REFERENCES r_mold(id) ON UPDATE CASCADE;


--
-- Name: wanted_ibfk_3; Type: FK CONSTRAINT; Schema: public; Owner: hamsteri
--
...
--
-- Name: dd_arvot; Type: ACL; Schema: public; Owner: hamsteri
--

REVOKE ALL ON TABLE dd_arvot FROM PUBLIC;
REVOKE ALL ON TABLE dd_arvot FROM hamsteri;
GRANT ALL ON TABLE dd_arvot TO hamsteri;


--
-- Name: kiekot; Type: ACL; Schema: public; Owner: hamsteri
--

REVOKE ALL ON TABLE kiekot FROM PUBLIC;
REVOKE ALL ON TABLE kiekot FROM hamsteri;
GRANT ALL ON TABLE kiekot TO hamsteri;


--
-- Name: kirppis; Type: ACL; Schema: public; Owner: hamsteri
--
...
--
-- Name: members; Type: ACL; Schema: public; Owner: hamsteri
--

REVOKE ALL ON TABLE members FROM PUBLIC;
REVOKE ALL ON TABLE members FROM hamsteri;
GRANT ALL ON TABLE members TO hamsteri;


--
-- Name: r_mold; Type: ACL; Schema: public; Owner: hamsteri
--

REVOKE ALL ON TABLE r_mold FROM PUBLIC;
REVOKE ALL ON TABLE r_mold FROM hamsteri;
GRANT ALL ON TABLE r_mold TO hamsteri;


--
-- Name: r_muovi; Type: ACL; Schema: public; Owner: hamsteri
--

REVOKE ALL ON TABLE r_muovi FROM PUBLIC;
REVOKE ALL ON TABLE r_muovi FROM hamsteri;
GRANT ALL ON TABLE r_muovi TO hamsteri;


--
-- Name: r_valm; Type: ACL; Schema: public; Owner: hamsteri
--

REVOKE ALL ON TABLE r_valm FROM PUBLIC;
REVOKE ALL ON TABLE r_valm FROM hamsteri;
GRANT ALL ON TABLE r_valm TO hamsteri;


--
-- Name: r_vari; Type: ACL; Schema: public; Owner: hamsteri
--

REVOKE ALL ON TABLE r_vari FROM PUBLIC;
REVOKE ALL ON TABLE r_vari FROM hamsteri;
GRANT ALL ON TABLE r_vari TO hamsteri;


--
-- Name: wanted; Type: ACL; Schema: public; Owner: hamsteri
--

REVOKE ALL ON TABLE wanted FROM PUBLIC;
REVOKE ALL ON TABLE wanted FROM hamsteri;
GRANT ALL ON TABLE wanted TO hamsteri;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT SELECT ON TABLES  TO hamsteri;
